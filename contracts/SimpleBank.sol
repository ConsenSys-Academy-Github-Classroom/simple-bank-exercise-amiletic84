...
contract SimpleBank {
    ...
    modifier haveBallance(uint amount) {
      require(balances[msg.sender] >= amount, "User does not have enough ballance");
      _;
    }
    ...
    function withdraw(uint withdrawAmount) public haveBallance(withdrawAmount) returns (uint) {
